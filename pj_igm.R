...
#se modifica plan eliminando las columnas innecesarias
  ...
  #  PLAN2M<-subset(PLAN2,PLAN2[["Proveedor2"]]=="Movistar CL")
  #  PLAN2E<-subset(PLAN2,PLAN2[["Proveedor2"]]=="Entel PCS (CL)")
  # a<-duplicated(PLAN2M,fromLast = TRUE)
  # PLAN2[["duplicado"]]<-a
  #  
   # UAAD_usersM<-subset(UAAD_users,UAAD_users[["Proveedor"]]=="Movistar CL")
  # UAAD_usersE<-subset(UAAD_users,UAAD_users[["Proveedor"]]=="Entel PCS (CL)")
  # UAADP_usosM <- merge(
  #   UAAD_usersM,
  #   PLAN2M,
